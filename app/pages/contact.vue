...
import { getConactShema } from "~~/server/shemas/contact";
import * as z from "zod";

const success = ref(false);
const submiting = ref(false);
const schema = getConactShema(Use.i18n.t);
...
<template>
  <Container>
    <div class="py-15">
      ...
      <ul class="flex justify-center gap-2 mt-5">
        <UButton
      ...
      <div class="pt-20 pb-10 px-5 sm:px-10 relative">
        ...
        >
          ...
          <template v-if="success">
            ...
            <MDC :value="$t('contacts.contact.success')" class="text-xl" />
          </template>
          <UButton
            v-else
            :loading="submiting"
